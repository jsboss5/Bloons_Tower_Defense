...
public class RegularAttacker extends Attacker {

  public RegularAttacker(int xPosition, int yPosition, int towerRank, int towerRange, int targetNum,
      int fireRate) {
    super(xPosition, yPosition, towerRank, towerRange, targetNum, fireRate);
  }

  public RegularAttacker(int xPosition, int yPosition) {
